...
class TermTests(unittest.TestCase):
    def test_constructor(self):
        ...
        self.assertGreaterEqual(len(params), 3, msg="Constructor for Term class should take three parameters")
        ...
        self.assertEqual(instance_vars['_keywords'], ["network layer", "protocol"], "_keywords instance variable should be initialized to the keywords passed to the Term class constructor")
